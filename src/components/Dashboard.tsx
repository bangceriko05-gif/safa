...
export default function Dashboard() {
  ...
  const websiteSubItems: { key: "storefront" | "orders" | "payments" | "barcode"; label: string; icon: typeof Package }[] = [
    { key: "storefront", label: "Tampilan Website Toko", icon: StoreIcon },
    { key: "orders", label: "Transaksi dari Website", icon: Receipt },
    { key: "payments", label: "Metode Pembayaran", icon: CreditCard },
              ...
              customersSection === "suppliers" ? (
                ...
                isFeatureEnabled("pos") ? (
                  <CRMDashboard
                    ...
                    initialCustomerPhone={searchParams.get("crmPhone") || undefined}
                    initialCustomerName={searchParams.get("crmName") || undefined}
                  />
                ) : (
